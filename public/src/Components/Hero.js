    ...
    <section className="h-[800px] bg-hero bg-no-repeat bg-cover bg-center py-24 ">
      <div className="container mx-auto flex justify-around h-full">
        ...
        <div className="flex flex-col justify-center">
          ...
          <Link
            className="text-white self-start flex items-center justify-center uppercase font-semibold border-b-2 border-primary ml-6 lg:ml-[330px] xl:ml-[480px] cursor-pointer"
            to={"/"}
          >
            Discover More
          </Link>
